...
def starting_turn_information(gr_cards_line: str, start_cards_line: str, deal_line: str, hands: list[set[str]], player_id: int) -> list[str]:
    row = []
...
def csv_rows(game: str) -> list[str]:
    ...
    rows: list[list[any]] = []
    for id_ in range(4):
        rows.append(starting_turn_information(gr_cards_lines_split[id_], start_cards_lines_split[id_], deal_lines_split[id_], hands, id_))
